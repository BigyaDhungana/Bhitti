...
public:
    ...
    void setupUi(QMainWindow *Login)
    {
        ...
        lineEdit->setGeometry(QRect(210, 160, 121, 21));
        lineEdit->setLayoutDirection(Qt::RightToLeft);
        lineEdit->setFrame(false);
        lineEdit->setAlignment(Qt::AlignCenter);
        lineEdit_2 = new QLineEdit(centralwidget);
        lineEdit_2->setObjectName(QString::fromUtf8("lineEdit_2"));
        lineEdit_2->setGeometry(QRect(210, 200, 121, 21));
        ...
        label_2->setGeometry(QRect(190, 160, 21, 21));
        ...
        label_3->setGeometry(QRect(190, 200, 21, 21));
