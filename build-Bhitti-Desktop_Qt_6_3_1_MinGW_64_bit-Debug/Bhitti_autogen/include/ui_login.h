...
public:
    ...
    void setupUi(QMainWindow *Login)
    {
        ...
        Logo->setGeometry(QRect(260, 30, 171, 101));
        Logo->setStyleSheet(QString::fromUtf8(""));
        Logo->setPixmap(QPixmap(QString::fromUtf8("C:/Users/Asus/Downloads/Vitti_Logo_FullRes.png")));
        Logo->setScaledContents(true);
        Logo->setOpenExternalLinks(false);
        Uname = new QLineEdit(centralwidget);
        Uname->setObjectName(QString::fromUtf8("Uname"));
        Uname->setEnabled(true);
        Uname->setGeometry(QRect(300, 210, 121, 21));
        Uname->setLayoutDirection(Qt::RightToLeft);
        Uname->setFrame(false);
        Uname->setAlignment(Qt::AlignCenter);
        Passwrd = new QLineEdit(centralwidget);
        Passwrd->setObjectName(QString::fromUtf8("Passwrd"));
        Passwrd->setGeometry(QRect(300, 250, 121, 21));
        Passwrd->setFrame(false);
        Passwrd->setEchoMode(QLineEdit::Password);
        Passwrd->setCursorPosition(0);
        Passwrd->setAlignment(Qt::AlignCenter);
...
"background-color: rgb(122, 122, 122);"));
        ...
        QWidget::setTabOrder(pushButton, Uname);
        QWidget::setTabOrder(Uname, Passwrd);
    ...
    void retranslateUi(QMainWindow *Login)
    {
        ...
        Uname->setPlaceholderText(QCoreApplication::translate("Login", "Username", nullptr));
        Passwrd->setPlaceholderText(QCoreApplication::translate("Login", "Password", nullptr));
